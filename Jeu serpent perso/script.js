...
function SnakeGame(canvasWidth, canvasHeight, blockSize, delay)
{
    ...
    this.canvas.style.border = "30px solid #000DC2";
    this.canvas.style.margin = "30px auto";
    this.canvas.style.display = "block";
    this.canvas.style.backgroundColor = "#71A4FF";
    ...
    this.gameOver = function()
    {
        ...
        this.ctx.fillStyle = "#6D007B";
        this.ctx.fillText('Clic "Espace" pour rejouer', centreX, centreY + 150);
        this.ctx.restore();
    };
    ...
    {
        this.ctx.save();
        this.ctx.font = "bold 250px sans-serif";
        this.ctx.fillStyle = "#BFBF00";
        this.ctx.textAlign = "center";
        this.ctx.textBaseline = "middle";
        var centreX = this.canvas.width / 2;
        var centreY = this.canvas.height / 2;
        this.ctx.strokeText(this.score.toString(), centreX, centreY);
